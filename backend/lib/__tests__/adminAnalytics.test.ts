  ...
  it("counts language usage", async () => {
    mockChain.then
      .mockImplementationOnce((resolve) =>
        Promise.resolve(resolve({
          data: [
            { percentage: 80, total_questions: 10, score: 8, topic_results: [], weak_topics: [], strong_topics: [], quizzes: { language_code: "en" }, created_at: "2024-01-01T00:00:00Z" },
            { percentage: 70, total_questions: 10, score: 7, topic_results: [], weak_topics: [], strong_topics: [], quizzes: { language_code: "hi" }, created_at: "2024-01-02T00:00:00Z" },
            { percentage: 60, total_questions: 10, score: 6, topic_results: [], weak_topics: [], strong_topics: [], quizzes: { language_code: "en" }, created_at: "2024-01-03T00:00:00Z" },
          ],
          error: null,
        }))
      )
